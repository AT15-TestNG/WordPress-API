...
public class CredentialsManager {
    ...
    private void initialize() {
        ...
        try {
            ...
            log.error("Error loading properties files: " + e.getMessage());
        }
    ...
    public static CredentialsManager getInstance() {
        return (instance == null) ? instance = new CredentialsManager() : instance;
    }
    ...
    public String getUserName(String userRole) {
        return getEnvironmentSetting("userType.userName").replace("usertype", userRole);
    }
